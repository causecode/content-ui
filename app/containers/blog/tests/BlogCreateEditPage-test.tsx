jest.unmock('../BlogCreatePage/BlogCreatePage');

import * as React from 'react';
import {shallow, ShallowWrapper} from 'enzyme';
import {Form} from '../../../components/blog/Form/Form';
import {IBlogEditPageProps, BlogEdit} from '../BlogEditPage/BlogEditPage';
import {BlogCreate, IBlogCreatePageProps} from '../BlogCreatePage/BlogCreatePage';
